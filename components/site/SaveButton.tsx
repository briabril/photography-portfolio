...
export function SaveButton({
  ...
  const tone =
    status === "saved"
      ? "border-[#7C9A82]/40 bg-[#7C9A82]/15 text-[#7C9A82]"
      : status === "error"
        ? "border-[#C1502E]/40 bg-[#C1502E]/15 text-[#C1502E]"
        : dirty
          ? "border-[#E3A94D]/50 bg-[#E3A94D]/10 text-[#E3A94D] hover:bg-[#E3A94D]/20"
          : "border-[#34302B] text-[#5C564A]"
